  ...
  return (
    <div className="app">
      ...
      <section className="what-i-do" data-aos="fade-up">
        <h2>What I Do</h2>
        <div className="grid">
          <div className="card"><h3>UI/UX Web Design</h3><p>Designing clean, modern, and user-friendly interfaces</p></div>
          <div className="card"><h3>Frontend Development</h3><p>Building responsive and fast web apps with React</p></div>
          <div className="card"><h3>Full-Stack Development</h3><p>Working with Node.js, Express, and MongoDB to power backend logic</p></div>
        </div>
      </section>
